class GearsController < ApplicationController
  ...
  private
    ...
    def gear_params
      params.require(:gear).permit(:name, :head_id, :cape_id, :neck_id, :ammunition_id, :weapon_id, :shield_id, :legs_id, :hands_id, :feet_id, :ring_id, :ammunition_amount, :chest_id)
    end
end
