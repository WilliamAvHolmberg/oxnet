...
class InventoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create inventory" do
    assert_difference('Inventory.count') do
      post inventories_url, params: { inventory: { inventory_item: @inventory.inventory_item, name: @inventory.name } }
    end
  ...
  test "should update inventory" do
    patch inventory_url(@inventory), params: { inventory: { inventory_item: @inventory.inventory_item, name: @inventory.name } }
