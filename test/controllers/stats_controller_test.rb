...
class StatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create stat" do
    assert_difference('Stat.count') do
      post stats_url, params: { stat: { account_id: @stat.account_id, level: @stat.level, skill_id: @stat.skill_id } }
    end
  ...
  test "should update stat" do
    patch stat_url(@stat), params: { stat: { account_id: @stat.account_id, level: @stat.level, skill_id: @stat.skill_id } }
