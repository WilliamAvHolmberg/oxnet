...
class RequirementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create requirement" do
    assert_difference('Requirement.count') do
      post requirements_url, params: { requirement: { level: @requirement.level, skill_id: @requirement.skill_id, task_id: @requirement.task_id } }
    end
  ...
  test "should update requirement" do
    patch requirement_url(@requirement), params: { requirement: { level: @requirement.level, skill_id: @requirement.skill_id, task_id: @requirement.task_id } }
