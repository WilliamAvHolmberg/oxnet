...
class QuestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create quest" do
    assert_difference('Quest.count') do
      post quests_url, params: { quest: { account_id: @quest.account_id, completed: @quest.completed, name: @quest.name } }
    end
  ...
  test "should update quest" do
    patch quest_url(@quest), params: { quest: { account_id: @quest.account_id, completed: @quest.completed, name: @quest.name } }
