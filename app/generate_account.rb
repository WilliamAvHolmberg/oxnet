...
def create_account
  ...
  computer = find_available_computer
...
def create_accounts_for_all_computers
  ...
  computers.each do |computer|
    ...
    if current_amount_of_accounts != nil && current_amount_of_accounts.size < 13
      #puts current_amount_of_accounts.size
      amount_of_accounts_to_create = 13 - current_amount_of_accounts.size
